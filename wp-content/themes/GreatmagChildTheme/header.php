  ...
  <div class="full-width-carousel-inner">
    <div class="full-width-carousel-dummy">
            <a href="" class="current full-width-carousel-item" data-i="0">
                ...
                <img src="http://localhost/BlueQuote/wp-content/uploads/2018/02/news-640x441.jpg" alt="INTRODUCING "BLUE NOTE REVIEW" – A NEW BIANNUAL LIMITED EDITION BOXSET SUBSCRIPTION SERIES" />
        </div>
        <div class="featured-carousel-bg">
        <h2 class="uppercase">PLACEHOLDER TEXT</h2>

					</div>
		      </a>
            <a href="" class="full-width-carousel-item" data-i="1">
		        <div class="full-width-carousel-item-inner">
          <img src="http://localhost/BlueQuote/wp-content/uploads/2017/12/25398312_384562478640829_4279158507161862933_o.jpg" alt="INTRODUCING "BLUE NOTE REVIEW" – A NEW BIANNUAL LIMITED EDITION BOXSET SUBSCRIPTION SERIES" />
        </div>
        <div class="featured-carousel-bg">
        ...
        <div class="featured-carousel-bg">
            ...
            <a href="" class="full-width-carousel-item featured-video" data-i="4">
		        ...
		        <div class="full-width-carousel-item-inner">
          <img src="http://localhost/BlueQuote/wp-content/uploads/2018/01/lejla4.jpg" alt=" "CYCLING THROUGH REALITY"" />
        </div>
        <div class="featured-carousel-bg">
