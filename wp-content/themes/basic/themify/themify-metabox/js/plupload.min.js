...
else{c("#"+g.id).fadeOut();h=b.file;g=b.url;var l=b.type;"zip"===l||"rar"===l||"plain"===l?window.location=location.href.replace(location.hash,""):c("#"+d).val(g);"undefined"!==typeof b.thumb&&(themifyMediaLib.setPreviewIcon(a.closest(".themify_field_row"),b.thumb),c("body").trigger("themify_plupload_selected",[a,b]));e&&(c("#"+d).closest("fieldset").children(".preset").find("img").removeClass("selected"),b=g.replace(/^.*[\\\/]/,""),b=c('<a href="#" title="'+b+'"><span title="'+h+'"></span><img src="'+
g+'" alt="'+g+'" class="backgroundThumb selected" /></a>').css("display","inline-block"),c("#"+d).closest("fieldset").children(".preset").append(b));f&&c("#"+d+"-preview").attr("src",g)}})}jQuery(document).ready(function(a){var d=a(".plupload-upload-uic");0<d.length&&d.each(function(){themify_create_pluploader(a(this))})});
