          ...
          var m = function() {
              ...
              return (0, d.default)(t, [{
                  ...
                  value: function(t) {
					  ...
					  if(window.parent.document != window.document && jQuery(window.parent.document).find(this.el).length > 0){
						  window.parent.document.addEventListener("mousemove", this.drag); window.parent.document.addEventListener("mouseup", this.endDrag);
					  }
                  }
              }, {
                  key: "drag",
                  ...
                  value: function() {
					  ...
					  if(window.parent.document != window.document && jQuery(window.parent.document).find(this.el).length > 0){
						  window.parent.document.removeEventListener("mousemove", this.drag); window.parent.document.removeEventListener("mouseup", this.endDrag);
					  }
                  }
              }, {
                  key: "resizeScrollbar",
                  value: function() {
                   ...
                   //console.log(o,r ,this.isVisible[t] )
                  }
              }, {
                  key: "resizeScrollContent",
                  value: function() {
                      var t = (0, v.default)();
                    //  console.log(this.contentEl.scrollHeight,this.el.offsetHeight,this.el,this.contentEl)
